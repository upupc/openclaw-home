...
_openclaw_message_send() {
  _arguments -C \
    ...
    "--channel[Channel: telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|dingtalk|bluebubbles|zalo|zalouser|synology-chat|tlon]" \
...
_openclaw_agent() {
  _arguments -C \
    ...
    "--channel[Delivery channel: last|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|dingtalk|bluebubbles|zalo|zalouser|synology-chat|tlon (omit to use the main session channel)]" \
...
_openclaw_china_setup() {
  _arguments -C \
    
}

_openclaw_china_about() {
  _arguments -C \
...
_openclaw_china() {
  ...
  _arguments -C \
     \
    "1: :_values 'command' 'setup[中国渠道交互式配置向导]' 'about[显示项目信息]'" \
    "*::arg:->args"

  case $state in
    (args)
      case $line[1] in
        (setup) _openclaw_china_setup ;;
        (about) _openclaw_china_about ;;
      esac
      ;;
  esac
}
...
_openclaw_channels_capabilities() {
  _arguments -C \
    "--channel[Channel (all|telegram|whatsapp|discord|irc|googlechat|slack|signal|imessage|line|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|dingtalk|bluebubbles|zalo|zalouser|synology-chat|tlon)]" \
