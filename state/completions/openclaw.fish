...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|dingtalk-connector)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|dingtalk-connector)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l failure-alert-channel -d 'Failure alert channel (last|dingtalk-connector)'
